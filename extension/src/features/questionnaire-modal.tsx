...
const questions: Question[] = [
  ...
  },
  {
    ...
    question: "How often did you use alternative methods to make purchases during the waiting period?",
    type: "rating",
    options: [
      "Never",
      "Once",
  ...
  },
  {
    ...
    description: "Which of the following sentences describes your behaviour change on the extension",
    type: "checkbox",
    options: [
  ...
  },
  {
    ...
    description: "Which of the following sentences describes your opinion on the extension?",
    type: "checkbox",
    options: [
  ...
  {
    id: "open_feedback",
    question: "Please share your thoughts and feelings on the experience of using this extension?",
    ...
    return (
        <div className="flex justify-between items-center gap-2 mt-4">
          {question.options.map((option) => (
            <Button key={option} className="w-full" onClick={() => handleRatingSelect(option)} 
      ...
      <>
        <CardHeader className="pb-2">
          <CardTitle className="text-2xl font-bold text-lessprimary">
            Less Extension Questionnaire
          </CardTitle>
          <CardDescription className="text-lg mt-2">
            Please help us understand your experience with the Less extension.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-8">
          ...
          <div className="space-y-2">
            ...
            {question.description && (
              <p className="text-lessmuted-foreground text-sm">{question.description}</p>
            )}
